...
| Role                    | Start Here                                                                                      | Duration |
| ----------------------- | ----------------------------------------------------------------------------------------------- | -------- |
| **Windows Developer**   | [Getting Started: Windows DevOps](devops/GettingStarted-WindowsDevOps.md)                       | 45 min   |
| **Backend Engineer**    | [Production Ready Software](code/ProductionReady.md) → [Microservices](devops/Microservices.md) | 2 hours  |
| **Solutions Architect** | [Continuous Architecture](devops/ContinuosArchitecture.md) → [CQRS](code/CQRS.md)               | 3 hours  |
| **DevOps Engineer**     | [Terraform](devops/terraform.md) → [Automation with PowerShell](devops/Automation.md)           | 2 hours  |

## DevOps Topics

| Topic                                                                     | Description                                                                                                                                                                                                             |
| ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Getting Started: Windows DevOps](devops/GettingStarted-WindowsDevOps.md) | Step-by-step setup of Git, PowerShell, Docker, and Azure CLI on Windows                                                                                                                                                 |
...
| Topic                                                                   | Description                                                                            |
| ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| [Production Ready Software](code/ProductionReady.md)                    | Checklist and patterns for building software safe for production deployment            |
| [Microservices Architecture - .NET](devops/Microservices.md)            | Design, build, and operate microservices in C# with health checks and resilience       |
| [Command Query Responsibility Segregation - CQRS](code/CQRS.md)         | Decouple reads and writes for independent scaling and consistency models               |
