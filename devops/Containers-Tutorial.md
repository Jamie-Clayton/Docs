# Containers Tutorial — Your First Redis on Docker
...
- **How-to page** — task-oriented recipes for RabbitMQ, secrets, and corporate-proxy network setups: [Containers-HowTo.md](./Containers-HowTo.md)
- **Reference page** — the full Docker CLI cheat sheet: [Containers-Reference.md](./Containers-Reference.md)
- **Explanation page** — why containers matter for local development, and what they don't solve: [Containers-Explanation.md](./Containers-Explanation.md)
